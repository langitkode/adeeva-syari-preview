...
import template9 from "@/templates/template-9";
...
export default function PreviewWrapper({ config }: PreviewWrapperProps) {
  ...
  const CurrentTemplate = templates[activeTemplate] || templates["template-10"] || Object.values(templates)[0];
